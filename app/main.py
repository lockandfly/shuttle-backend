...
# ---------------------------------------------------------
# REALI E FUNZIONANTI (basati sulla tua struttura)
# ---------------------------------------------------------
...
app = FastAPI(
    ...
    description="Sistema completo di gestione operativa Lock&Fly",
    version="1.0.0"
)
...
@app.get("/")
def root():
    return {"status": "ok", "message": "Lock&Fly backend attivo"}
